...
namespace bridge {
    ...
    namespace utils {
        ...
        size_t getScalarTypeSize(slang::TypeReflection::ScalarType scalarType)
        {
            switch (scalarType)
            {
                case slang::TypeReflection::ScalarType::None:       return 0;
                case slang::TypeReflection::ScalarType::Void:       return 0;
                case slang::TypeReflection::ScalarType::Bool:       return 1;
                ...
                case slang::TypeReflection::ScalarType::Float16:    return 2;
        ...
        VertexInputFormat getFormat(slang::TypeReflection::ScalarType scalarType, uint32_t componentCount)
        {
            switch (scalarType)
            {
            ...
            for (uint32_t i = 0; i < fieldCount; i++)
            {
                ...
                switch (fieldType->getKind())
                {
                    ...
                    case slang::TypeReflection::Kind::Vector:
                        offset += utils::getScalarTypeSize(fieldType->getScalarType()) * fieldType->getElementCount();
                        attribute.Format = utils::getFormat(fieldType->getScalarType(), fieldType->getElementCount());
                        locationsUsed++;
                        break;
                    case slang::TypeReflection::Kind::Matrix:
                    {
                        ...
                        size_t columnSize = utils::getScalarTypeSize(fieldType->getScalarType()) * fieldType->getColumnCount();
                        ...
                        for (uint32_t j = 0; j < columns; j++)
                        {
                            ...
                            matAttr.Format = utils::getFormat(fieldType->getScalarType(), rows);
